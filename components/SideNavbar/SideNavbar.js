...
export default function SideNavbar({ toggleSideNav }) {
    ...
    return (
        <aside className={`bgPrimaryLight my-4 border-round transition-all transition-duration-500 ${toggleSideNav ? 'w-3' : 'w-4rem'}`}>
            <Flex direction={'column'} >
                <Flex className={'align-items-center justify-content-around gap-2 p-2 h-5rem'} >
                    ...
                    <Flex className={'align-items-center gap-2'}>
                        ...
                        <Transition
                            show={toggleSideNav}
                            enter={'transition-all transition-duration-300'}
                            enterFrom=" opacity-0"
                            enterTo=" opacity-100"
                            leave="transition-all transition-duration-300"
                            leaveFrom="opacity-100 "
                            leaveTo="opacity-0 "
                        >
                            <Flex direction={'column'} >
